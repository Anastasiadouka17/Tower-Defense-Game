...
public class MiniTester {
    ...
    private static void busyBeeTest1() {
        ...
        if (bee.getHealth() != 5) {
            System.out.println("Health is initialized to a wrong value. Expected: 5, actual: "+bee.getHealth());
            containsError = true;
        }
        if (bee.getCost() != 2) {
            System.out.println("Food cost is initialized to a wrong value. Expected: 2, actual: "+bee.getCost());
            containsError = true;
        }
    }
    ...
    private static void busyBeeTest2() {
        ...
        if (food != 2) {
            System.out.println("takeAction() adds wrong amount of food to the tile. Expected: 2, actual: "+food);
            containsError = true;
        }
    }
    ...
    private static void honeyBeeTest1() {
        ...
        if (bee.getCost() != 2) {
            System.out.println("getCost() returns the wrong food cost. Expected: 2, actual: " + bee.getCost());
            containsError = true;
        }
    }
    ...
    private static void hornetTest1() {
        ...
        if (!hornet.takeAction()) {
            System.out.println("Hornet: takeAction() returns the wrong value. Expected: true, actual: false");
            containsError = true;
        }
        if (bee.getHealth() != 4) {
            System.out.println("Hornet: takeAction() does the wrong amount of damage to bee. " +
                    "Expected: 4, actual: "+bee.getHealth());
            containsError = true;
        }
    }
    ...
    private static void hornetTest2() {
        ...
        Hornet hornet = new Hornet(t, 10, 2);
        if (hornet.takeAction()) {
            System.out.println("Hornet: takeAction() returns the wrong value. Expected: false, actual: true");
            containsError = true;
        }
    }
    ...
    private static void hornetTest4() {
        ...
        if (hornet.getHealth() != 10) {
            System.out.println("Hornet: Health is initialized to a wrong value. " +
                    "Expected: 10, actual: "+hornet.getHealth());
            containsError = true;
        }
        try {
    ...
    private static void insectTest1() {
        ...
        if (!exceptionCaught) {
            System.out.println("Insect: Constructor incorrectly deals with the case of " +
    ...
    private static void insectTest2() {
        ...
        if (insect.getHealth() != 5) {
            System.out.println("Insect: getHealth() returns the wrong health. Expected: 5, actual: "+insect.getHealth());
            containsError = true;
        }
    }
    ...
    private static void stingyBeeTest1() {
        Tile hive = new Tile();
        hive.buildHive();
        Tile nest = new Tile();
        nest.buildNest();
        ...
        StingyBee bee = new StingyBee(t, 2);
        Hornet hornet = new Hornet(t, 10, 2);
        if (!bee.takeAction()) {
            System.out.println("StingyBee: takeAction() returns the wrong value. (expected: true, actual: false)");
            containsError = true;
        }
        if (hornet.getHealth() != 8) {
            System.out.println("StingyBee: takeAction() does the wrong amount of damage to hornet. " +
                    "Expected: 8, actual: "+hornet.getHealth());
            containsError = true;
        }
    }

    private static void stingyBeeTest2() {
        Tile t = new Tile();
        StingyBee bee = new StingyBee(t, 2);
        if (bee.takeAction()) {
            System.out.println("StingyBee: takeAction() returns the wrong value. Expected: false, actual: true");
            containsError = true;
        }
    }

    private static void stingyBeeTest3() {
        Tile s = new Tile();
        Tile t = new Tile();
        StingyBee bee1 = new StingyBee(s, 1);
        StingyBee bee2 = new StingyBee(t, 1);
        if (bee1.equals(bee2)) {
            System.out.println("StingyBee: equals() doesn't compare two stingy bees correctly.");
            containsError = true;
        }
    }

    private static void stingyBeeTest4() {
        Tile t = new Tile();
        StingyBee bee = new StingyBee(t, 2);
        if (bee.getHealth() != 10) {
            System.out.println("StingyBee: Health is initialized to a wrong value. " +
                    "Expected: 10, actual: "+bee.getHealth());
            containsError = true;
        }
        if (bee.getCost() != 1) {
            System.out.println("StingyBee: Food cost is initialized to a wrong value. " +
                    "Expected: 1, actual: "+bee.getCost());
            containsError = true;
        }
        try {
            boolean damageField = false;
            for (Field field : StingyBee.class.getDeclaredFields()) {
                field.setAccessible(true);
            ...
            if (!damageField) {
                System.out.println("StingyBee: Damage is initialized to a wrong value. (expected: 2)");
                containsError = true;
            }
        } catch(IllegalAccessException e) {
            e.printStackTrace();
    ...
    private static void swarmOfHornetsTest1() {
        ...
        if (size != 4 || !Arrays.equals(actual, expected)) {
            System.out.println("addHornet() did not update the size field and/or list" +
                    " of hornets field correctly.");
            containsError = true;
        }
    }
    ...
    private static void swarmOfHornetsTest2() {
        ...
        if (size != 1 || !Arrays.equals(actual, expected)) {
            System.out.println("addHornet() did not update the size field and/or list of hornets field correctly.");
            containsError = true;
        }
    }
    ...
    private static void swarmOfHornetsTest4() {
        ...
        Hornet first = swarm.getFirstHornet();
        if (first != null) {
            System.out.println("getFirstHornet() did not return null when there were no hornets in the swarm.");
            containsError = true;
        }
    }
    ...
    private static void swarmOfHornetsTest5() {
        ...
        if (b) {
            System.out.println("removeHornet() did not return false when the hornet was not in the array.");
            containsError = true;
        }
    }
    ...
    private static void tankyBeeTest1() {
        ...
        if (hornet.getHealth() != 8) {
            System.out.println("TankyBee: takeAction() does the wrong amount of damage to hornet. " +
                    "Expected: 8, actual: "+hornet.getHealth());
            containsError = true;
        }
    }
    ...
    private static void tankyBeeTest2() {
        ...
        TankyBee bee = new TankyBee(t, 2, 10);
        if (bee.takeAction()) {
            System.out.println("TankyBee: takeAction() returns the wrong value. Expected: false, actual: true");
            containsError = true;
        }
    }
    ...
    private static void tankyBeeTest3() {
        ...
        bee.takeDamage(2);
        if (bee.getHealth() != 29) {
            System.out.println("TankyBee: takeDamage() does the wrong amount of damage to itself. " +
                    "Expected: 29, actual: "+bee.getHealth());
            containsError = true;
        }
    }
    ...
    private static void tankyBeeTest5() {
        ...
        TankyBee bee = new TankyBee(t, 2, 10);
        if (bee.getHealth() != 30) {
            System.out.println("TankyBee: Health is initialized to a wrong value. " +
                    "Expected: 30, actual: "+bee.getHealth());
            containsError = true;
        }
        if (bee.getCost() != 3) {
            System.out.println("TankyBee: Food cost is initialized to a wrong value. " +
                    "Expected: 3, actual: "+bee.getCost());
            containsError = true;
        }
        try {
            boolean damageField = false;
    ...
    private static void tileTest6() {
        ...
        try {
            boolean field1 = false, field2 = false, field3 = false, field4 = false,
                    field5 = false, field6 = false, field7 = false;
